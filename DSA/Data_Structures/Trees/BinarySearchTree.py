...
# Every node within the tree must refer to at most 2 children nodes
# Left child is always less than its parent, right child is always greater than its parent.
# every sub-tree within a BST is also a BST, and there should be no duplicates.
